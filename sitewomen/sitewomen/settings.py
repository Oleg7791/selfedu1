...
SECRET_KEY = 'django-insecure-9gb#r$8j&@jo0t6%ab7tsrk2g7@%f4c!mc9$l1mu=&zrtj^gr+'
...
# константа для перенаправления при успешной авторизации
LOGIN_REDIRECT_URL = 'home'
# константа для перенаправления при выходе
